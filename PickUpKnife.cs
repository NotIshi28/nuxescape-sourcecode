...
public class PickUpKnife : MonoBehaviour
{
    ...
    {
        if (other.gameObject.tag == "Reach" && !openText.activeInHierarchy && box.isOpen == true)
        {
            inReach = true;
        ...
        else if (other.gameObject.tag == "Reach" && openText.activeInHierarchy && box.isOpen == false)
        {
            inReach = false;
            pickUpText.SetActive(false);
